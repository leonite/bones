<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
					...
					<main id="main" class="m-all t-2of3 d-5of7 ld-5of7 borderleft cf" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
						...
						<?php else : ?>
							...
							<article id="post-not-found" class="hentry cf">
									...
									<footer class="article-footer">
											<p><?php _e( 'This is the error message in the single.php template.', 'leonitetheme' ); ?></p>
									</footer>
							</article>
